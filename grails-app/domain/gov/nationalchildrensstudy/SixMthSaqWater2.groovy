...
class SixMthSaqWater2 {
	...
	public static final String XSD_TABLE_NAME = "six_mth_saq_water_2"

	public SixMthSaqWater2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'six_mth_saq_id':
									...
									break
								case 'six_month_water_id':
									sixMonthWaterId = elementText
									break
								case 'water_1':
	...
	static constraints = {
		...
		water1(nullable: false, inList:[1, 2, 3, 4, -1, -2, -3, -4])
