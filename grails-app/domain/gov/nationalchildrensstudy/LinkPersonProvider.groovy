...
class LinkPersonProvider {
	...
	String personId
	Integer isActive
	Integer provIntroOutcome
	String provIntroOutcomeOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "link_person_provider"

	public LinkPersonProvider(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'person_provider_id':
									personProviderId = elementText
									break
								case 'provider_id':
								...
								case 'is_active':
									...
									break
								case 'prov_intro_outcome':
									provIntroOutcome = elementText.toInteger()
									break
								case 'prov_intro_outcome_oth':
									provIntroOutcomeOth = elementText
									break
	...
	static constraints = {
		...
		provIntroOutcome(nullable: false, inList:[1, 2, 3, 4, -5, -7, -4])
