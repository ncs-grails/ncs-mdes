...
class TwentyFourMthMother2 {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_2"

	public TwentyFourMthMother2(XMLStreamReader reader, boolean strict) {
	...
	static mapping = {
		table 'twenty_four_mth_mother_2'
