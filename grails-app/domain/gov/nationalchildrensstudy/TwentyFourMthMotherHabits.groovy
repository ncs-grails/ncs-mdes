...
class TwentyFourMthMotherHabits {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_habits"

	public TwentyFourMthMotherHabits(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'suppl_take':
									...
									break
								case 'supple_freq_unit':
									suppleFreqUnit = elementText.toInteger()
									break
								case 'time_stamp_7':
