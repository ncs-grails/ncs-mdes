...
class PregScreenEhKnowNcs2 {
	...
	public static final String XSD_TABLE_NAME = "preg_screen_eh_know_ncs_2"

	public PregScreenEhKnowNcs2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'ps_eh_how_know_ncs_id':
									psEhHowKnowNcsId = elementText
									break
								case 'ps_eh_id':
									psEhId = elementText
									break
