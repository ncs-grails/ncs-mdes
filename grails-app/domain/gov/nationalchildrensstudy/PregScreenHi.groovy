...
class PregScreenHi {
	...
	public static final String XSD_TABLE_NAME = "preg_screen_hi"

	public PregScreenHi(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		rGender(nullable: false, inList:[1, 2, 3, -6, -3, -4])
