...
class PregVisit1LocalTrav2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_1_local_trav_2"

	public PregVisit1LocalTrav2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv1_local_trav_id':
									pv1LocalTravId = elementText
									break
								case 'pv1_id':
									pv1Id = elementText
									break
								case 'local_trav':
									localTrav = elementText.toInteger()
									break
								case 'local_trav_oth':
	...
	static constraints = {
		...
		localTrav(nullable: false, inList:[1, 2, 3, 4, -5, -1, -2, -3, -4])
