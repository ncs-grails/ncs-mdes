...
class TapWaterTwfSubsamples {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twf_subsamples"

	public TapWaterTwfSubsamples(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twf_id':
									...
									break
								case 'tap_water_twf_subsamples_id':
									tapWaterTwfSubsamplesId = elementText
									break
								case 'twf_subsamples':
