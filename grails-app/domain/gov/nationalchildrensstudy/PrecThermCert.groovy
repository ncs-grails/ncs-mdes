...
class PrecThermCert {
	...
	Integer precisionCertStatus
	String certificationDate
	String certificationExpireDt
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "prec_therm_cert"

	public PrecThermCert(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'certification_id':
									certificationId = elementText
									break
								case 'precision_cert_status':
									precisionCertStatus = elementText.toInteger()
									break
								case 'certification_date':
									certificationDate = elementText
									break
	...
	static constraints = {
		...
		precisionCertStatus(nullable: false, inList:[1, 2, -4])
