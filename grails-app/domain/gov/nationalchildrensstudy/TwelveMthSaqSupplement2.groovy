...
class TwelveMthSaqSupplement2 {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_saq_supplement_2"

	public TwelveMthSaqSupplement2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twelve_mth_saq_id':
									...
									break
								case 'twelve_mth_saq_supplement_id':
									twelveMthSaqSupplementId = elementText
									break
								case 'supplement':
									supplement = elementText.toInteger()
									break
								case 'supplement_oth':
									supplementOth = elementText
									break
	...
	static constraints = {
		...
		supplement(nullable: false, inList:[1, 2, 3, 5, -1, -2, -4, -7])
