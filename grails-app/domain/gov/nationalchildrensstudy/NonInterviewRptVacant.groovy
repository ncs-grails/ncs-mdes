...
class NonInterviewRptVacant {
	...
	public static final String XSD_TABLE_NAME = "non_interview_rpt_vacant"

	public NonInterviewRptVacant(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'nir_vacant_id':
									nirVacantId = elementText
									break
								case 'nir_id':
									nirId = elementText
									break
								case 'nir_vacant':
									nirVacant = elementText.toInteger()
									break
								case 'nir_vacant_oth':
									nirVacantOth = elementText
									break
	...
	static constraints = {
		...
		nirVacant(nullable: false, inList:[1, 2, 3, 4, 5, 6, -5, -7, -4])
