...
class LowHighScript {
	...
	public static final String XSD_TABLE_NAME = "low_high_script"

	public LowHighScript(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'out_answer_oth':
									...
									break
								case 'out_speak':
									outSpeak = elementText.toInteger()
									break
								case 'out_avail':
									outAvail = elementText.toInteger()
									break
								case 'out_visit':
									outVisit = elementText.toInteger()
									break
								case 'out_visit_ucla':
									outVisitUcla = elementText.toInteger()
									break
								case 'out_talk':
									outTalk = elementText.toInteger()
									break
								case 'r_best_ttc_1':
								...
								case 'r_best_ttc_3':
									...
									break
								case 'out_unavail':
									outUnavail = elementText.toInteger()
									break
								case 'best_ttc_1':
								...
								case 'best_ttc_3':
									...
									break
								case 'out_nextph':
									outNextph = elementText
									break
								case 'in_visit':
									inVisit = elementText.toInteger()
									break
								case 'in_visit_ucla':
									inVisitUcla = elementText.toInteger()
									break
								case 'ppg_confirm':
									ppgConfirm = elementText.toInteger()
									break
								case 'followup_1':
									followup1 = elementText.toInteger()
									break
								case 'followup_3':
									followup3 = elementText.toInteger()
									break
