...
class TapWaterTwfNCollected {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twf_n_collected"

	public TapWaterTwfNCollected(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twf_id':
									...
									break
								case 'tap_water_twf_n_collected_id':
									tapWaterTwfNCollectedId = elementText
									break
