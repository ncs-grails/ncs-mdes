...
class LinkPersonHousehold {
	...
	public static final String XSD_TABLE_NAME = "link_person_household"

	public LinkPersonHousehold(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'is_active':
									...
									break
								case 'hh_rank':
									hhRank = elementText.toInteger()
									break
								case 'hh_rank_oth':
									hhRankOth = elementText
									break
	...
	static constraints = {
		...
		hhRank(nullable: false, inList:[1, 2, 3, 4, -5, -4])
