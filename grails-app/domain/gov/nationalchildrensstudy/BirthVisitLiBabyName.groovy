...
class BirthVisitLiBabyName {
	...
	public static final String XSD_TABLE_NAME = "birth_visit_li_baby_name"

	public BirthVisitLiBabyName(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'bv_li_id':
									bvLiId = elementText
									break
								case 'birth_visit_li_baby_name_id':
									birthVisitLiBabyNameId = elementText
									break
								case 'baby_name':
									babyName = elementText.toInteger()
									break
								case 'baby_fname':
									babyFname = elementText
									break
								case 'baby_mname':
									babyMname = elementText
									break
								case 'baby_lname':
									babyLname = elementText
									break
								case 'baby_sex':
									babySex = elementText.toInteger()
									break
								case 'baby_bwt_lb':
									babyBwtLb = elementText.toInteger()
									break
								case 'baby_bwt_oz':
									babyBwtOz = elementText.toInteger()
									break
	...
	static constraints = {
		...
		babySex(nullable: false, inList:[1, 2, 3, -1, -2, -4])
