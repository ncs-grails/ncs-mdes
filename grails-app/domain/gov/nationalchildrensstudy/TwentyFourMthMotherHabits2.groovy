...
class TwentyFourMthMotherHabits2 {

	Integer psuId
	String twentyFourMth2Id
	String pId
	String twentyFourMthHabits2Id
	Integer sleepHrsDay
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_habits_2"

	public TwentyFourMthMotherHabits2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'twenty_four_mth_habits_2_id':
									twentyFourMthHabits2Id = elementText
									break
								case 'sleep_hrs_day':
	...
	static constraints = {
		...
		twentyFourMthHabits2Id(nullable: false, minSize:1, maxSize:36)
	...
	static mapping = {
		table 'twenty_four_mth_mother_habits_2'

		psuId column:'psu_id'
		twentyFourMth2Id column:'twenty_four_mth_2_id'
		pId column:'p_id'
		twentyFourMthHabits2Id column:'twenty_four_mth_habits_2_id'
