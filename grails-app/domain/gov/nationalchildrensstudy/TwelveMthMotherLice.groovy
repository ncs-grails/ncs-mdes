...
class TwelveMthMotherLice {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_mother_lice"

	public TwelveMthMotherLice(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twelve_mth_id':
									...
									break
								case 'twelve_mth_mother_lice_id':
									twelveMthMotherLiceId = elementText
									break
								case 'lice_2':
