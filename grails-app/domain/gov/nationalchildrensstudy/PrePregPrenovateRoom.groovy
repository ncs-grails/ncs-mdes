...
class PrePregPrenovateRoom {
	...
	public static final String XSD_TABLE_NAME = "pre_preg_prenovate_room"

	public PrePregPrenovateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pp_renovate_room_id':
									ppRenovateRoomId = elementText
									break
								case 'pp_id':
									ppId = elementText
									break
