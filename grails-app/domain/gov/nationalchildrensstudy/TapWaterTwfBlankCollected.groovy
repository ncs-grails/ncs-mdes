...
class TapWaterTwfBlankCollected {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twf_blank_collected"

	public TapWaterTwfBlankCollected(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twf_id':
									...
									break
								case 'tap_water_twf_blank_coll_id':
									tapWaterTwfBlankCollId = elementText
									break
	...
	static constraints = {
		...
		reasTwfBlNCollected(nullable: false, inList:[1, 2, 3, -5, -3, -4])
