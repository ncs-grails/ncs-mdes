...
class PregVisit2RoomMold2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_2_room_mold_2"

	public PregVisit2RoomMold2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv2_room_mold_id':
									pv2RoomMoldId = elementText
									break
								case 'pv2_id':
									pv2Id = elementText
									break
