...
class PpgDetails {
	...
	public static final String XSD_TABLE_NAME = "ppg_details"

	public PpgDetails(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'ppg_details_id':
									ppgDetailsId = elementText
									break
								case 'p_id':
									pId = elementText
									break
								case 'ppg_pid_status':
									ppgPidStatus = elementText.toInteger()
									break
								case 'ppg_first':
								...
								case 'orig_due_date':
									...
									break
								case 'due_date_2':
									dueDate2 = elementText
									break
								case 'due_date_3':
									dueDate3 = elementText
									break
	...
	static constraints = {
		...
		ppgPidStatus(nullable: false, inList:[1, 2, 3, 4, 5, -4])
