...
class PpgSaq {
	...
	public static final String XSD_TABLE_NAME = "ppg_saq"

	public PpgSaq(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'contact':
									...
									break
								case 'home_address':
									homeAddress = elementText
									break
								case 'mail_address':
									mailAddress = elementText
									break
								case 'phone':
									phone = elementText
									break
