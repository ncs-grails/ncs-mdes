...
class ThreeMthMotherRace {
	...
	public static final String XSD_TABLE_NAME = "three_mth_mother_race"

	public ThreeMthMotherRace(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'three_mth_id':
									...
									break
								case 'three_mth_race_id':
									threeMthRaceId = elementText
									break
								case 'race':
