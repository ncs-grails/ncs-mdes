...
class TwelveMthMotherRenovateRoom {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_mother_renovate_room"

	public TwelveMthMotherRenovateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twelve_mth_id':
									...
									break
								case 'twelve_mth_ren_room_id':
									twelveMthRenRoomId = elementText
									break
								case 'renovate_room':
