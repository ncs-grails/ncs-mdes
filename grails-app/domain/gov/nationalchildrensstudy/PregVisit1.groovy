...
class PregVisit1 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_1"

	public PregVisit1(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'prenovate':
									...
									break
								case 'prenovate_room_oth':
									prenovateRoomOth = elementText
									break
								case 'pdecorate':
									pdecorate = elementText.toInteger()
									break
								case 'pdecorate_room_oth':
									pdecorateRoomOth = elementText
									break
								case 'time_stamp_11':
								...
								case 'shift_work':
									...
									break
								case 'commute_oth':
									commuteOth = elementText
									break
								case 'commute_time':
									commuteTime = elementText.toInteger()
									break
								case 'local_trav_oth':
									localTravOth = elementText
									break
								case 'pump_gas':
