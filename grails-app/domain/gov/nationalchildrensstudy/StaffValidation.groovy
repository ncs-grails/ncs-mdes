...
class StaffValidation {
	...
	String staffId
	String eventId
	Integer staffValidate
	String staffValDate
	String staffValComment
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "staff_validation"

	public StaffValidation(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'event_id':
									...
									break
								case 'staff_validate':
									staffValidate = elementText.toInteger()
									break
								case 'staff_val_date':
									staffValDate = elementText
									break
								case 'staff_val_comment':
									staffValComment = elementText
									break
	...
	static constraints = {
		...
		staffValidate(nullable: false, inList:[1, 2, -7, -4])
