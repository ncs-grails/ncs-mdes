...
class PbRecruitmentInfoSource {
	...
	Integer pbInstiInfoSource
	String pbInstiInfoSourceOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "pb_recruitment_info_source"

	public PbRecruitmentInfoSource(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'pb_recruitment_id':
									...
									break
								case 'pb_recruit_info_source_id':
									pbRecruitInfoSourceId = elementText
									break
								case 'pb_insti_info_source':
									pbInstiInfoSource = elementText.toInteger()
									break
								case 'pb_insti_info_source_oth':
									pbInstiInfoSourceOth = elementText
									break
	...
	static constraints = {
		...
		pbInstiInfoSource(nullable: false, inList:[1, 2, 3, 4, -1, -2, -5, -4])
