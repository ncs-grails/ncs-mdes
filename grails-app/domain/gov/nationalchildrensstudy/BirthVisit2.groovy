...
class BirthVisit2 {
	...
	public static final String XSD_TABLE_NAME = "birth_visit_2"

	public BirthVisit2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		planFeed(nullable: false, inList:[1, 2, 3, -5, -1, -3, -2, -4])
