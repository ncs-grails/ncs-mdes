...
class OutreachLang2 {
	...
	public static final String XSD_TABLE_NAME = "outreach_lang2"

	public OutreachLang2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'outreach_lang2_id':
									outreachLang2Id = elementText
									break
