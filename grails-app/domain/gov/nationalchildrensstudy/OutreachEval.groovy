...
class OutreachEval {
	...
	Integer outreachEval
	String outreachEvalOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "outreach_eval"

	public OutreachEval(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'outreach_event_eval_id':
									outreachEventEvalId = elementText
									break
								case 'outreach_event_id':
									outreachEventId = elementText
									break
								case 'outreach_eval':
									outreachEval = elementText.toInteger()
									break
								case 'outreach_eval_oth':
									outreachEvalOth = elementText
									break
	...
	static constraints = {
		...
		outreachEval(nullable: false, inList:[1, 2, 3, 4, -5, -7, -4])
