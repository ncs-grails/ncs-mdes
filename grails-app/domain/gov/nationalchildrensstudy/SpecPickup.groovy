...
class SpecPickup {
	...
	Integer specimenPickupComment
	String specimenPickupCmtOth
	BigDecimal specimenTransTemp
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "spec_pickup"

	public SpecPickup(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'staff_id':
									staffId = elementText
									break
								case 'specimen_pickup_dt':
									specimenPickupDt = elementText
									break
								case 'specimen_pickup_comment':
									specimenPickupComment = elementText.toInteger()
									break
								case 'specimen_pickup_cmt_oth':
									specimenPickupCmtOth = elementText
									break
								case 'specimen_trans_temp':
									specimenTransTemp = elementText.toBigDecimal()
									break
	...
	static constraints = {
		...
		specimenPickupComment(nullable: false, inList:[1, 2, 3, 4, 5, 6, -7, -4])
