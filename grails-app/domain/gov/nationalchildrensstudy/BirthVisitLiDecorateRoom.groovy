...
class BirthVisitLiDecorateRoom {
	...
	Integer decorateRoom
	String decorateRoomOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "birth_visit_li_decorate_room"

	public BirthVisitLiDecorateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'bv_li_id':
									bvLiId = elementText
									break
								case 'bv_decorate_room_id':
									bvDecorateRoomId = elementText
									break
								case 'decorate_room':
									decorateRoom = elementText.toInteger()
									break
	...
	static constraints = {
		...
		decorateRoom(nullable: false, inList:[1, 2, 3, 4, 5, 6, 7, -5, -1, -2, -4])
