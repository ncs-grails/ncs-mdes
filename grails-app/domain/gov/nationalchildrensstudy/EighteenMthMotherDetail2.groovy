...
class EighteenMthMotherDetail2 {

	Integer psuId
	String eighteenMthMother2Id
	String pId
	String eighteenMthDetail2Id
	Integer childQnum
	Integer childSex
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_detail_2"

	public EighteenMthMotherDetail2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'eighteen_mth_detail_2_id':
									eighteenMthDetail2Id = elementText
									break
								case 'child_qnum':
	...
	static constraints = {
		...
		eighteenMthDetail2Id(nullable: false, minSize:1, maxSize:36)
	...
	static mapping = {
		table 'eighteen_mth_mother_detail_2'

		psuId column:'psu_id'
		eighteenMthMother2Id column:'eighteen_mth_mother_2_id'
		pId column:'p_id'
		eighteenMthDetail2Id column:'eighteen_mth_detail_2_id'
