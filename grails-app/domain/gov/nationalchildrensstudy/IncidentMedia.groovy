...
class IncidentMedia {
	...
	String incidentId
	Integer inclossMedia
	String inclossMediaOth
	Integer inssev
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "incident_media"

	public IncidentMedia(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'incident_media_id':
									incidentMediaId = elementText
									break
								case 'incident_id':
									incidentId = elementText
									break
								case 'incloss_media':
									inclossMedia = elementText.toInteger()
									break
								case 'incloss_media_oth':
									inclossMediaOth = elementText
									break
								case 'inssev':
									inssev = elementText.toInteger()
									break
	...
	static constraints = {
		...
		inclossMedia(nullable: false, inList:[1, 2, 3, -5, -4])
		inclossMediaOth(nullable: true, maxSize:255)
		inssev(nullable: false, inList:[1, 2, 3, 4, -4])
