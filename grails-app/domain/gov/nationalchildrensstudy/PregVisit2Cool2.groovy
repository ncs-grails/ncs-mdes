...
class PregVisit2Cool2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_2_cool_2"

	public PregVisit2Cool2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		cool(nullable: false, inList:[1, 2, 3, 4, -5, -1, -2, -4])
