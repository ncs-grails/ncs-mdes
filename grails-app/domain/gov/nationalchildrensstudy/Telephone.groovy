...
class Telephone {
	...
	public static final String XSD_TABLE_NAME = "telephone"

	public Telephone(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'provider_id':
									...
									break
								case 'phone_info_source':
									phoneInfoSource = elementText.toInteger()
									break
								case 'phone_info_source_oth':
									phoneInfoSourceOth = elementText
									break
								case 'phone_info_date':
									phoneInfoDate = elementText
									break
								case 'phone_info_update':
									phoneInfoUpdate = elementText
									break
								case 'phone_nbr':
									phoneNbr = elementText
									break
								case 'phone_ext':
									phoneExt = elementText
									break
								case 'phone_type':
								...
								case 'phone_type_oth':
									...
									break
								case 'phone_rank':
									phoneRank = elementText.toInteger()
									break
								case 'phone_rank_oth':
									phoneRankOth = elementText
									break
								case 'phone_landline':
									phoneLandline = elementText.toInteger()
									break
								case 'phone_share':
									phoneShare = elementText.toInteger()
									break
								case 'cell_permission':
									cellPermission = elementText.toInteger()
									break
								case 'text_permission':
									textPermission = elementText.toInteger()
									break
								case 'phone_comment':
									phoneComment = elementText
									break
								case 'phone_start_date':
									phoneStartDate = elementText
									break
								case 'phone_end_date':
									phoneEndDate = elementText
									break
	...
	static constraints = {
		...
		cellPermission(nullable: false, inList:[1, 2, -7, -4])
		textPermission(nullable: false, inList:[1, 2, -6, -7, -4])
