...
class EighteenMthMotherPrescr {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_prescr"

	public EighteenMthMotherPrescr(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'eighteen_mth_mother_prescr_id':
									eighteenMthMotherPrescrId = elementText
									break
								case 'prescrmed':
