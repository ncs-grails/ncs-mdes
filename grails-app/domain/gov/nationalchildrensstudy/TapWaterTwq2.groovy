...
class TapWaterTwq2 {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twq_2"

	public TapWaterTwq2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'tap_water_twq_2_id':
									tapWaterTwq2Id = elementText
									break
								case 'recruit_type':
								...
								case 'time_stamp_1':
									...
									break
								case 'twq_okay':
									twqOkay = elementText.toInteger()
									break
								case 'twq_location':
									twqLocation = elementText.toInteger()
									break
								case 'twq_location_oth':
									twqLocationOth = elementText
									break
								case 'twq_coll_date':
									twqCollDate = elementText
									break
								case 'time_stamp_2':
									timeStamp2 = elementText
									break
								case 'twq_collect':
									twqCollect = elementText.toInteger()
									break
								case 'bottle1_filled':
								...
								case 'reas_bottle_n_filled_oth':
									...
									break
								case 'twq_filtered':
									twqFiltered = elementText.toInteger()
									break
								case 'twq_none_suppl_missing':
									twqNoneSupplMissing = elementText
									break
								case 'reason_twq_n_collected_oth':
									reasonTwqNCollectedOth = elementText
									break
								case 'twq_blank_collect':
									twqBlankCollect = elementText.toInteger()
									break
								...
								case 'bl_reas_bottle_n_filled_oth':
									...
									break
								case 'twq_bl_none_suppl_missing':
									twqBlNoneSupplMissing = elementText
									break
								case 'reas_twq_bl_n_collected_oth':
									reasTwqBlNCollectedOth = elementText
									break
								case 'twq_dp_collect':
									twqDpCollect = elementText.toInteger()
									break
								...
								case 'dp_reas_bottle_n_filled_oth':
									...
									break
								case 'reas_twq_dp_n_collected_suppl':
									reasTwqDpNCollectedSuppl = elementText
									break
								case 'reas_twq_dp_n_collected_oth':
									reasTwqDpNCollectedOth = elementText
									break
								case 'twq_comments':
									twqComments = elementText
									break
								case 'time_stamp_3':
	...
	static constraints = {
		...
		tapWaterTwq2Id(nullable: false, minSize:1, maxSize:36)
		...
		twqCollDate(nullable: true, maxSize:10, matches:"([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?")
	...
	static mapping = {
		table 'tap_water_twq_2'

		psuId column:'psu_id'
		tapWaterTwq2Id column:'tap_water_twq_2_id'
		...
		twqCollDate column:'twq_coll_date'
