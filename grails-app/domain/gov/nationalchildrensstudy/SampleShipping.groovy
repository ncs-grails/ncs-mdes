...
class SampleShipping {
	...
	String staffId
	String shipperId
	Integer shipperDestination
	String shipmentDate
	Integer shipmentCoolant
	String shipmentTrackingNo
	String shipmentIssuesOth
	String staffIdTrack
	Integer sampleShippedBy
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "sample_shipping"

	public SampleShipping(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'shipper_destination':
									shipperDestination = elementText.toInteger()
									break
								case 'shipment_date':
									shipmentDate = elementText
									break
								case 'shipment_coolant':
									shipmentCoolant = elementText.toInteger()
									break
								...
								case 'shipment_issues_oth':
									...
									break
								case 'staff_id_track':
									staffIdTrack = elementText
									break
								case 'sample_shipped_by':
									sampleShippedBy = elementText.toInteger()
									break
	...
	static constraints = {
		...
		shipperDestination(nullable: false, inList:[1, 2, 3, 4, -4])
