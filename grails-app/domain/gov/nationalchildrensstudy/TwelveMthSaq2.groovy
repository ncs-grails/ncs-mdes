...
class TwelveMthSaq2 {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_saq_2"

	public TwelveMthSaq2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'milk_other_unit':
									...
									break
								case 'breast_milk_fed':
									breastMilkFed = elementText.toInteger()
									break
								case 'breast_stop':
								...
								case 'pumped_2':
									...
									break
								case 'formula_fed':
									formulaFed = elementText.toInteger()
									break
								case 'formula_last7':
