...
class TwentyFourMthMotherDetail2 {

	Integer psuId
	String twentyFourMth2Id
	String pId
	String twentyFourMthDetail2Id
	Integer childQnum
	Integer childSex
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_detail_2"

	public TwentyFourMthMotherDetail2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'twenty_four_mth_detail_2_id':
									twentyFourMthDetail2Id = elementText
									break
								case 'child_qnum':
	...
	static constraints = {
		...
		twentyFourMthDetail2Id(nullable: false, minSize:1, maxSize:36)
	...
	static mapping = {
		table 'twenty_four_mth_mother_detail_2'

		psuId column:'psu_id'
		twentyFourMth2Id column:'twenty_four_mth_2_id'
		pId column:'p_id'
		twentyFourMthDetail2Id column:'twenty_four_mth_detail_2_id'
