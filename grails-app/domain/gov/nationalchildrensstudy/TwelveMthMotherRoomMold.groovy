...
class TwelveMthMotherRoomMold {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_mother_room_mold"

	public TwelveMthMotherRoomMold(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twelve_mth_id':
									...
									break
								case 'twelve_mth_room_mold_id':
									twelveMthRoomMoldId = elementText
									break
								case 'room_mold':
