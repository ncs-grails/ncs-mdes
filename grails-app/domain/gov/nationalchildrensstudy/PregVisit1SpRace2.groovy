...
class PregVisit1SpRace2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_1_sp_race_2"

	public PregVisit1SpRace2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv1_sp_race_id':
									pv1SpRaceId = elementText
									break
								case 'pv1_id':
									pv1Id = elementText
									break
								case 'sp_race':
									spRace = elementText.toInteger()
									break
								case 'sp_race_oth':
	...
	static constraints = {
		...
		spRace(nullable: false, inList:[1, 2, 3, 4, 5, 6, -5, -1, -2, -3, -4])
