...
class PbRecruitmentProvSvc2 {
	...
	public static final String XSD_TABLE_NAME = "pb_recruitment_prov_svc_2"

	public PbRecruitmentProvSvc2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'pb_recruitment_id':
									...
									break
								case 'pb_recruit_prov_svc_id':
									pbRecruitProvSvcId = elementText
									break
								case 'pb_prov_svc':
									pbProvSvc = elementText.toInteger()
									break
								case 'pb_prov_svc_oth':
									pbProvSvcOth = elementText
									break
	...
	static constraints = {
		...
		pbProvSvc(nullable: false, inList:[1, 2, 3, 4, -1, -2, -5, -4])
