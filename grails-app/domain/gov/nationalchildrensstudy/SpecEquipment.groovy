...
class SpecEquipment {
	...
	public static final String XSD_TABLE_NAME = "spec_equipment"

	public SpecEquipment(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		equipmentType(nullable: false, inList:[1, 2, 3, 4, 5, -5, -7, -4])
