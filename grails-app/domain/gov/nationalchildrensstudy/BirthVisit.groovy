...
class BirthVisit {
	...
	public static final String XSD_TABLE_NAME = "birth_visit"

	public BirthVisit(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'decorate':
									...
									break
								case 'decorate_room_oth':
									decorateRoomOth = elementText
									break
								case 'smoke':
								...
								case 'where_move':
									...
									break
								case 'plan_move_info':
									planMoveInfo = elementText.toInteger()
									break
								...
								case 'time_stamp_11':
									...
									break
								case 'respondent':
									respondent = elementText.toInteger()
									break
								case 'contact_type':
	...
	static constraints = {
		...
		liveMom(nullable: false, inList:[1, 2, -1, -2, -3, -4])
		...
		fedBaby(nullable: false, inList:[1, 2, -1, -2, -3, -4])
		...
		posHosp(nullable: false, inList:[1, 2, 3, -1, -2, -3, -4])
		posHome(nullable: false, inList:[1, 2, 3, -1, -2, -3, -4])
		sleepRoom(nullable: false, inList:[1, 2, 3, 4, -1, -2, -3, -4])
		bed(nullable: false, inList:[1, 2, 3, 4, 5, 6, -5, -1, -2, -3, -4])
		...
		hcare(nullable: false, inList:[1, 2, 3, 4, -1, -2, -4])
