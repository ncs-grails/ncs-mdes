...
class TapWaterTwq {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twq"

	public TapWaterTwq(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'tap_water_twq_id':
									tapWaterTwqId = elementText
									break
								case 'recruit_type':
