...
class TwelveMthSaqFormulaType2 {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_saq_formula_type_2"

	public TwelveMthSaqFormulaType2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twelve_mth_saq_id':
									...
									break
								case 'twelve_mth_saq_formula_type_id':
									twelveMthSaqFormulaTypeId = elementText
									break
								case 'formula_type':
									formulaType = elementText.toInteger()
									break
	...
	static constraints = {
		...
		formulaType(nullable: false, inList:[1, 2, 3, 4, -1, -2, -3, -4])
