...
class OutreachStaff {
	...
	public static final String XSD_TABLE_NAME = "outreach_staff"

	public OutreachStaff(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'outreach_event_staff_id':
									outreachEventStaffId = elementText
									break
