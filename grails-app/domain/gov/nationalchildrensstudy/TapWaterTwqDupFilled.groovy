...
class TapWaterTwqDupFilled {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twq_dup_filled"

	public TapWaterTwqDupFilled(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twq_id':
									...
									break
								case 'tap_water_twq_dup_filled_id':
									tapWaterTwqDupFilledId = elementText
									break
