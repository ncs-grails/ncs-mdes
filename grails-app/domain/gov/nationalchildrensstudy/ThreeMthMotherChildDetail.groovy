...
class ThreeMthMotherChildDetail {
	...
	public static final String XSD_TABLE_NAME = "three_mth_mother_child_detail"

	public ThreeMthMotherChildDetail(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'three_month_detail_loop_id':
									threeMonthDetailLoopId = elementText
									break
								case 'child_qnum':
