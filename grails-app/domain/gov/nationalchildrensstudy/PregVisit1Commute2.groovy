...
class PregVisit1Commute2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_1_commute_2"

	public PregVisit1Commute2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv1_commute_id':
									pv1CommuteId = elementText
									break
								case 'pv1_id':
									pv1Id = elementText
									break
								case 'commute':
									commute = elementText.toInteger()
									break
								case 'commute_oth':
	...
	static constraints = {
		...
		commute(nullable: false, inList:[1, 2, 3, 4, 5, -5, -1, -2, -3, -4])
