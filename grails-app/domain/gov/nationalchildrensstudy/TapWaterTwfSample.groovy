...
class TapWaterTwfSample {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twf_sample"

	public TapWaterTwfSample(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twf_id':
									...
									break
								case 'tap_water_twf_sample_id':
									tapWaterTwfSampleId = elementText
									break
								case 'sample_number':
