...
class InternetUsage {
	...
	public static final String XSD_TABLE_NAME = "internet_usage"

	public InternetUsage(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'internet_usage_id':
									internetUsageId = elementText
									break
								case 'recruit_type':
								...
								case 'time_stamp_1':
									...
									break
								case 'prefer_contact':
									preferContact = elementText.toInteger()
									break
								case 'ever_connect':
									everConnect = elementText.toInteger()
									break
								case 'use_web':
									useWeb = elementText.toInteger()
									break
								case 'have_email':
									haveEmail = elementText.toInteger()
									break
								case 'check_email':
									checkEmail = elementText.toInteger()
									break
								case 'ok_email_addr':
									okEmailAddr = elementText.toInteger()
									break
								case 'email':
									email = elementText
									break
								case 'prefer_survey':
									preferSurvey = elementText.toInteger()
									break
								case 'dc_mode_simple':
									dcModeSimple = elementText.toInteger()
									break
								case 'dc_mode_convenient':
									dcModeConvenient = elementText.toInteger()
									break
								case 'dc_mode_choice':
									dcModeChoice = elementText.toInteger()
									break
								case 'time_stamp_2':
