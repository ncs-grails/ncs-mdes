...
class TwentyFourMthMotherOtc {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_otc"

	public TwentyFourMthMotherOtc(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'twenty_four_mth_mother_otc_id':
									twentyFourMthMotherOtcId = elementText
									break
								case 'otcmed':
									otcmed = elementText
									break
