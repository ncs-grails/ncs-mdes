...
class SixMthSaq2 {
	...
	public static final String XSD_TABLE_NAME = "six_mth_saq_2"

	public SixMthSaq2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'breast_milk':
									...
									break
								case 'breast_unit':
									breastUnit = elementText.toInteger()
									break
								case 'formula_often':
									formulaOften = elementText.toInteger()
									break
								case 'formula_often_unit':
									formulaOftenUnit = elementText.toInteger()
									break
								case 'cow_milk':
									cowMilk = elementText.toInteger()
									break
								case 'cow_milk_unit':
									cowMilkUnit = elementText.toInteger()
									break
								case 'milk_other':
									milkOther = elementText.toInteger()
									break
								case 'milk_other_unit':
									milkOtherUnit = elementText.toInteger()
									break
								case 'pumped_2':
