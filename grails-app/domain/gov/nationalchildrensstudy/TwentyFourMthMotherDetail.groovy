...
class TwentyFourMthMotherDetail {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_detail"

	public TwentyFourMthMotherDetail(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'twenty_four_mth_detail_id':
									twentyFourMthDetailId = elementText
									break
								case 'child_qnum':
