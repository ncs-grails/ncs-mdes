...
class EighteenMthMotherCond {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_cond"

	public EighteenMthMotherCond(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'eighteen_mth_habits_id':
									eighteenMthHabitsId = elementText
									break
								case 'eighteen_mth_mother_cond_id':
									eighteenMthMotherCondId = elementText
									break
								case 'cond':
	...
	static constraints = {
		...
		cond(nullable: false, inList:[1, 2, 3, -1, -2, -4])
