...
class PregVisit1PrenovateRoom2 {
	...
	String pv1Id
	Integer prenovateRoom
	String prenovateRoomOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "preg_visit_1_prenovate_room_2"

	public PregVisit1PrenovateRoom2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv1_prenovate_room_id':
									pv1PrenovateRoomId = elementText
									break
								case 'pv1_id':
									pv1Id = elementText
									break
								case 'prenovate_room':
									prenovateRoom = elementText.toInteger()
									break
	...
	static constraints = {
		...
		prenovateRoom(nullable: false, inList:[1, 2, 3, 4, 5, 6, 7, -5, -1, -2, -3, -4])
