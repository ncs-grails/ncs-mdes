...
class EighteenMthMotherOtc {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_otc"

	public EighteenMthMotherOtc(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'eighteen_mth_mother_otc_id':
									eighteenMthMotherOtcId = elementText
									break
								case 'otcmed':
									otcmed = elementText
									break
