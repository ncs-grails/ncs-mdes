...
class BirthVisitLiRenovateRoom {
	...
	public static final String XSD_TABLE_NAME = "birth_visit_li_renovate_room"

	public BirthVisitLiRenovateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'bv_li_id':
									bvLiId = elementText
									break
								case 'bv_renovate_room_id':
									bvRenovateRoomId = elementText
									break
								case 'renovate_room':
