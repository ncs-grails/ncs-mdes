...
class NonInterviewRptNoaccess {
	...
	public static final String XSD_TABLE_NAME = "non_interview_rpt_noaccess"

	public NonInterviewRptNoaccess(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'nir_noaccess_id':
									nirNoaccessId = elementText
									break
								case 'nir_id':
									nirId = elementText
									break
