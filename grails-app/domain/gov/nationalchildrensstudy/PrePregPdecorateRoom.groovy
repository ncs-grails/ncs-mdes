...
class PrePregPdecorateRoom {
	...
	public static final String XSD_TABLE_NAME = "pre_preg_pdecorate_room"

	public PrePregPdecorateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pp_decorate_room_id':
									ppDecorateRoomId = elementText
									break
								case 'pp_id':
									ppId = elementText
									break
	...
	static constraints = {
		...
		decorateRoom(nullable: false, inList:[1, 2, 3, 4, 5, 6, 7, -5, -1, -2, -3, -4])
