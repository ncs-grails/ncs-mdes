...
class NonInterviewRptDutype {
	...
	public static final String XSD_TABLE_NAME = "non_interview_rpt_dutype"

	public NonInterviewRptDutype(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'nir_dutype_id':
									nirDutypeId = elementText
									break
								case 'nir_id':
									nirId = elementText
									break
								case 'nir_type_du':
									nirTypeDu = elementText.toInteger()
									break
								case 'nir_type_du_oth':
									nirTypeDuOth = elementText
									break
	...
	static constraints = {
		...
		nirTypeDu(nullable: false, inList:[1, 2, 3, -5, -7, -4])
