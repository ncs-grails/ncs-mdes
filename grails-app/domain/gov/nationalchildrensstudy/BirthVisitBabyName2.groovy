...
class BirthVisitBabyName2 {
	...
	public static final String XSD_TABLE_NAME = "birth_visit_baby_name_2"

	public BirthVisitBabyName2(XMLStreamReader reader, boolean strict) {
