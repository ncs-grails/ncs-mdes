...
class PersonRace {
	...
	public static final String XSD_TABLE_NAME = "person_race"

	public PersonRace(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		race(nullable: false, inList:[1, 2, 3, 4, 5, 6, -1, -6, -5, -4])
