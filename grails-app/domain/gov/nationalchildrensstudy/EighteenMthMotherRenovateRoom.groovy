...
class EighteenMthMotherRenovateRoom {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_renovate_room"

	public EighteenMthMotherRenovateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'eighteen_mth_mother_id':
									...
									break
								case 'eighteen_mth_mother_renovate_room_id':
									eighteenMthMotherRenovateRoomId = elementText
									break
								case 'renovate_room':
