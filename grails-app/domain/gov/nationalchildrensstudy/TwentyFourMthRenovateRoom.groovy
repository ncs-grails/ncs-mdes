...
class TwentyFourMthRenovateRoom {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_renovate_room"

	public TwentyFourMthRenovateRoom(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'twenty_four_mth_id':
									twentyFourMthId = elementText
									break
								case 'twenty_four_mth_renovate_room_id':
									twentyFourMthRenovateRoomId = elementText
									break
								case 'renovate_room':
