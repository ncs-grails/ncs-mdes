...
class PbRecruitmentProvSource2 {
	...
	public static final String XSD_TABLE_NAME = "pb_recruitment_prov_source_2"

	public PbRecruitmentProvSource2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		pbProvSource(nullable: false, inList:[1, 2, 3, -1, -2, -4])
