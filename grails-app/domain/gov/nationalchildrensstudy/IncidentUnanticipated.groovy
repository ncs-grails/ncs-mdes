...
class IncidentUnanticipated {
	...
	String incidentId
	Integer incUnanticipated
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "incident_unanticipated"

	public IncidentUnanticipated(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'inc_unanticipated_id':
									incUnanticipatedId = elementText
									break
								case 'incident_id':
									incidentId = elementText
									break
								case 'inc_unanticipated':
									incUnanticipated = elementText.toInteger()
									break
	...
	static constraints = {
		...
		incUnanticipated(nullable: false, inList:[1, 2, 3, -4])
