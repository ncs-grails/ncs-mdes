...
class FatherPv12 {
	...
	public static final String XSD_TABLE_NAME = "father_pv1_2"

	public FatherPv12(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		nameConfirm(nullable: false, inList:[1, 2, -1, -2, -3, -4])
