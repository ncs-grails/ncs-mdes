...
class PregVisitLiCool2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_li_cool_2"

	public PregVisitLiCool2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		cool(nullable: false, inList:[1, 2, 3, -7, -5, -1, -2, -3, -4])
