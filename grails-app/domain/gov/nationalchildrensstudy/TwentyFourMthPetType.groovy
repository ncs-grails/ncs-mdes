...
class TwentyFourMthPetType {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_pet_type"

	public TwentyFourMthPetType(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twenty_four_mth_id':
									...
									break
								case 'twenty_four_mth_pet_type_id':
									twentyFourMthPetTypeId = elementText
									break
								case 'pet_type':
