...
class EighteenMthMotherPetType {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_pet_type"

	public EighteenMthMotherPetType(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'eighteen_mth_mother_id':
									...
									break
								case 'eighteen_mth_mother_pet_type_id':
									eighteenMthMotherPetTypeId = elementText
									break
								case 'pet_type':
