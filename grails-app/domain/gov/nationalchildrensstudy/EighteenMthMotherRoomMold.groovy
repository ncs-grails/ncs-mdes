...
class EighteenMthMotherRoomMold {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_room_mold"

	public EighteenMthMotherRoomMold(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'eighteen_mth_room_mold_id':
									eighteenMthRoomMoldId = elementText
									break
