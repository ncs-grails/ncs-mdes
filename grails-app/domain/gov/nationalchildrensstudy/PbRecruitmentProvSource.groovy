...
class PbRecruitmentProvSource {
	...
	Integer pbProvSource
	String pbProvSourceOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "pb_recruitment_prov_source"

	public PbRecruitmentProvSource(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'pb_recruitment_id':
									...
									break
								case 'pb_recruit_prov_source_id':
									pbRecruitProvSourceId = elementText
									break
								case 'pb_prov_source':
									pbProvSource = elementText.toInteger()
									break
								case 'pb_prov_source_oth':
									pbProvSourceOth = elementText
									break
	...
	static constraints = {
		...
		pbProvSource(nullable: false, inList:[1, 2, 3, 4, -1, -2, -5, -4])
