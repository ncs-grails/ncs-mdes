...
class PregScreenPb2 {
	 ...
	 * Status level 2
	 */
	PregnancyTryingStatusCl4 trying
	/**
	 * Status level 2
	 */
	 ...
	 * Status level 2
	 */
	ConfirmTypeCl7 bioFatherHome
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 partnerTrying
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 biofatherRaise
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 socfatherRaise
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 fatherAvail
	/**
	 * Status level 2
	 */
	String timeStamp12
	...
	static constraints = {
		...
		bioFatherHome(nullable: false)
		partnerTrying(nullable: false)
		biofatherRaise(nullable: false)
		socfatherRaise(nullable: false)
		fatherAvail(nullable: false)
		timeStamp12(nullable: true, maxSize:19, matches:"([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9])?")
		otherFemale(nullable: false)
