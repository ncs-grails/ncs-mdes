...
class PregScreenPb2 {
	...
	public static final String XSD_TABLE_NAME = "preg_screen_pb_2"

	public PregScreenPb2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		female1(nullable: false, inList:[1, 2, -1, -2, -4])
		...
		duEligConfirm(nullable: false, inList:[1, 2, 3, -3, -4])
		...
		trying(nullable: false, inList:[1, 2, 3, 4, -1, -2, -3, -4])
