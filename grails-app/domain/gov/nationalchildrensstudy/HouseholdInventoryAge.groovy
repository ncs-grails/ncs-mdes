...
class HouseholdInventoryAge {
	...
	public static final String XSD_TABLE_NAME = "household_inventory_age"

	public HouseholdInventoryAge(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'household_inventory_age_id':
									householdInventoryAgeId = elementText
									break
								case 'p_age':
