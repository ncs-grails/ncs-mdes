...
class TapWaterTwfReasonFilled {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twf_reason_filled"

	public TapWaterTwfReasonFilled(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twf_id':
									...
									break
								case 'tap_water_twf_reason_filled_id':
									tapWaterTwfReasonFilledId = elementText
									break
