...
class SixMthSaqFormulaType2 {
	...
	public static final String XSD_TABLE_NAME = "six_mth_saq_formula_type_2"

	public SixMthSaqFormulaType2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'six_mth_saq_id':
									...
									break
								case 'six_mth_formula_type_id':
									sixMthFormulaTypeId = elementText
									break
								case 'formula_type':
