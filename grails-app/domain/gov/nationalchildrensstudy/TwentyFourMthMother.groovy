...
class TwentyFourMthMother {
	 ...
	 * Status level 2
	 */
	ConfirmTypeCl7 workLastContact
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 workCurrently
	/**
	 * Status level 2
	 */
	Integer workHrs
	 ...
	 * Status level 2
	 */
	SmokingAllowedCl1 smokeRules
	/**
	 * Status level 2
	 */
	ConfirmTypeCl8 drink
	/**
	 * Status level 2
	 */
	AlcoholFrequencyCl3 drinkNow
	/**
	 * Status level 2
	 */
	 ...
	 * Status level 2
	 */
	ConfirmTypeCl7 petMeds
	/**
	 * Status level 2
	 */
	PastPeriodCl1 petMedTime
	/**
	 * Status level 2
	 */
	String timeStamp11
	 ...
	 * Status level 2
	 */
	ConfirmTypeCl7 covers
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 vacuum
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 removal
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 method
	/**
	 * PII level P
	 * Status level 2
	 */
	 ...
	 * Status level 2
	 */
	ConfirmTypeCl7 airFilter
	/**
	 * Status level 2
	 */
	WindowOpenCl1 openWindow
	/**
	 * Status level 2
	 */
	ConfirmTypeCl7 roach
	/**
	 * Status level 2
	 */
	 ...
	 * Status level 2
	 */
	NeighborhoodDefinitionCl2 neighDefn
	/**
	 * Status level 2
	 */
	QuantityCl2 neighFam
	/**
	 * Status level 2
	 */
	QuantityCl2 neighFriend
	/**
	 * Status level 2
	 */
	QuantityCl2 neighbors
	/**
	 * Status level 2
	 */
	NeighborTalkQuantityCl2 neighNumTalk
	/**
	 * Status level 2
	 */
	RegularityLevelCl15 neighHelp
	/**
	 * Status level 2
	 */
	RegularityLevelCl15 neighTalk
	/**
	 * Status level 2
	 */
	LikelihoodCl2 neighWatch1
	/**
	 * Status level 2
	 */
	LikelihoodCl2 neighWatch2
	/**
	 * Status level 2
	 */
	AgreementLevelCl3 neighClose
	/**
	 * Status level 2
	 */
	AgreementLevelCl3 neighTrust
	/**
	 * Status level 2
	 */
	AgreementLevelCl3 neighSafe1
	/**
	 * Status level 2
	 */
	AgreementLevelCl3 neighSafe2
	/**
	 * Status level 2
	 */
	AgreementLevelCl3 neighSafe3
	/**
	 * Status level 2
	 */
	String timeStamp13
	...
	static constraints = {
		...
		workLastContact(nullable: false)
		workCurrently(nullable: false)
		workHrs(nullable: true, matches:"([-+]?[\\d]{1,9})?")
		rSmoke(nullable: false)
		numSmoker(nullable: true, matches:"([-+]?[\\d]{1,9})?")
		smokeRules(nullable: false)
		drink(nullable: false)
		...
		pets(nullable: false)
		petMeds(nullable: false)
		petMedTime(nullable: false)
		timeStamp11(nullable: true, maxSize:19, matches:"([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9])?")
		covers(nullable: false)
		vacuum(nullable: false)
		removal(nullable: false)
		method(nullable: false)
		methodOth(nullable: true, maxSize:255)
		airFilter(nullable: false)
		openWindow(nullable: false)
		roach(nullable: false)
		water(nullable: false)
		mold(nullable: false)
		renovate(nullable: false)
		...
		neighDefn(nullable: false)
		neighFam(nullable: false)
		neighFriend(nullable: false)
		neighbors(nullable: false)
		neighNumTalk(nullable: false)
		neighHelp(nullable: false)
		neighTalk(nullable: false)
		neighWatch1(nullable: false)
		neighWatch2(nullable: false)
		neighClose(nullable: false)
		neighTrust(nullable: false)
		neighSafe1(nullable: false)
		neighSafe2(nullable: false)
		neighSafe3(nullable: false)
