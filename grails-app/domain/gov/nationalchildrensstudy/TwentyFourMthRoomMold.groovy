...
class TwentyFourMthRoomMold {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_room_mold"

	public TwentyFourMthRoomMold(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twenty_four_mth_id':
									...
									break
								case 'twenty_four_mth_room_mold_id':
									twentyFourMthRoomMoldId = elementText
									break
								case 'room_mold':
