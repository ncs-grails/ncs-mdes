...
class EnvEquipment {
	...
	String retiredDate
	Integer retiredReason
	String retiredReasonOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "env_equipment"

	public EnvEquipment(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'equipment_type_oth':
									...
									break
								case 'serial_no':
									serialNo = elementText
									break
								case 'government_asset_tag_no':
									governmentAssetTagNo = elementText
									break
								case 'retired_date':
									retiredDate = elementText
									break
								case 'retired_reason':
									retiredReason = elementText.toInteger()
									break
								case 'retired_reason_oth':
									retiredReasonOth = elementText
									break
