...
class EighteenMthMotherHabits {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_habits"

	public EighteenMthMotherHabits(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'eighteen_mth_mother_habits_id':
									eighteenMthMotherHabitsId = elementText
									break
								case 'time_stamp_3':
