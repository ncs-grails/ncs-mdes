...
class SixMthMother {
	...
	public static final String XSD_TABLE_NAME = "six_mth_mother"

	public SixMthMother(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'time_stamp_10':
									...
									break
								case 'work_preg':
									workPreg = elementText.toInteger()
									break
								case 'work_now':
									workNow = elementText.toInteger()
									break
								case 'work_now_oth':
									workNowOth = elementText
									break
								case 'work_hrs':
								...
								case 'num_smoker':
									...
									break
								case 'smoke_inside':
									smokeInside = elementText.toInteger()
									break
								case 'smoke_rules':
								...
								case 'time_stamp_12':
									...
									break
								case 'pay_bills':
									payBills = elementText.toInteger()
									break
								case 'wic':
									wic = elementText.toInteger()
									break
								case 'food_stamp':
									foodStamp = elementText.toInteger()
									break
								case 'tanf':
									tanf = elementText.toInteger()
									break
								case 'time_stamp_13':
									timeStamp13 = elementText
									break
								case 'nonenglish_freq':
									nonenglishFreq = elementText.toInteger()
									break
								case 'time_stamp_14':
								...
								case 'income':
									...
									break
								case 'income2':
									income2 = elementText.toInteger()
									break
								case 'fam_support':
									famSupport = elementText.toInteger()
									break
								case 'fam_support_num':
									famSupportNum = elementText.toInteger()
									break
								case 'time_stamp_15':
