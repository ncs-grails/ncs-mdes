...
class StaffWeeklyExpense {
	...
	public static final String XSD_TABLE_NAME = "staff_weekly_expense"

	public StaffWeeklyExpense(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'weekly_exp_id':
									weeklyExpId = elementText
									break
								case 'staff_id':
									staffId = elementText
									break
								case 'week_start_date':
									weekStartDate = elementText
									break
								case 'staff_pay':
									staffPay = elementText.toBigDecimal()
									break
								case 'staff_hours':
									staffHours = elementText.toBigDecimal()
									break
								case 'staff_expenses':
									staffExpenses = elementText.toBigDecimal()
									break
								case 'staff_miles':
									staffMiles = elementText.toBigDecimal()
									break
								case 'weekly_expenses_comment':
									weeklyExpensesComment = elementText
									break
