...
class SampleReceiptConfirm {
	...
	public static final String XSD_TABLE_NAME = "sample_receipt_confirm"

	public SampleReceiptConfirm(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'shipment_condition':
									shipmentCondition = elementText.toInteger()
									break
								case 'shipment_damaged_reason':
									shipmentDamagedReason = elementText
									break
								case 'sample_id':
									sampleId = elementText
									break
								case 'sample_receipt_temp':
									sampleReceiptTemp = elementText.toBigDecimal()
									break
								case 'sample_condition':
									sampleCondition = elementText.toInteger()
									break
								case 'shipment_received_by':
									shipmentReceivedBy = elementText
									break
