...
class SpecCordBloodSpecimen2 {
	...
	public static final String XSD_TABLE_NAME = "spec_cord_blood_specimen_2"

	public SpecCordBloodSpecimen2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'spec_cord_blood_id':
									...
									break
								case 'spec_cord_blood_specimen_id':
									specCordBloodSpecimenId = elementText
									break
	...
	static mapping = {
		table 'spec_cord_blood_specimen_2'
