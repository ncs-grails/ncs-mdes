...
class TwentyFourMthMotherCond {
	...
	public static final String XSD_TABLE_NAME = "twenty_four_mth_mother_cond"

	public TwentyFourMthMotherCond(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'twenty_four_mth_habits_id':
									twentyFourMthHabitsId = elementText
									break
								case 'twenty_four_month_mother_cond_id':
									twentyFourMonthMotherCondId = elementText
									break
								case 'cond':
									cond = elementText.toInteger()
									break
	...
	static constraints = {
		...
		cond(nullable: false, inList:[1, 2, 3, -1, -2, -3, -4])
