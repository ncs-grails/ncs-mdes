...
class TapWaterTwfDupCollected {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twf_dup_collected"

	public TapWaterTwfDupCollected(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twf_id':
									...
									break
								case 'tap_water_twf_dup_coll_id':
									tapWaterTwfDupCollId = elementText
									break
