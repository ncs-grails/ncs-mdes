...
class EighteenMthMotherLice {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_lice"

	public EighteenMthMotherLice(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'eighteen_mth_mother_id':
									...
									break
								case 'eighteen_mth_mother_lice_id':
									eighteenMthMotherLiceId = elementText
									break
								case 'lice_2':
