...
class LinkContact {
	...
	public static final String XSD_TABLE_NAME = "link_contact"

	public LinkContact(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'contact_link_id':
									contactLinkId = elementText
									break
								case 'contact_id':
