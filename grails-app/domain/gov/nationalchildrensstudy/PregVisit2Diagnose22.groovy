...
class PregVisit2Diagnose22 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_2_diagnose_2_2"

	public PregVisit2Diagnose22(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv2_diagnose2_id':
									pv2Diagnose2Id = elementText
									break
								case 'pv2_id':
									pv2Id = elementText
									break
	...
	static constraints = {
		...
		diagnose2(nullable: false, inList:[1, 2, 3, 4, 5, 6, -5, -1, -2, -4])
