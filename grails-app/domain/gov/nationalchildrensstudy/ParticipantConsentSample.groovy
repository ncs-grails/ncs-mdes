...
class ParticipantConsentSample {
	...
	Integer sampleConsentType
	Integer sampleConsentGiven
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "participant_consent_sample"

	public ParticipantConsentSample(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'participant_consent_id':
									...
									break
								case 'participant_consent_sample_id':
									participantConsentSampleId = elementText
									break
								case 'sample_consent_type':
									sampleConsentType = elementText.toInteger()
									break
								case 'sample_consent_given':
									sampleConsentGiven = elementText.toInteger()
									break
