...
class PregScreenHiKnowNcs2 {
	...
	public static final String XSD_TABLE_NAME = "preg_screen_hi_know_ncs_2"

	public PregScreenHiKnowNcs2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'ps_hi_how_know_ncs_id':
									psHiHowKnowNcsId = elementText
									break
								case 'ps_hi_id':
									psHiId = elementText
									break
