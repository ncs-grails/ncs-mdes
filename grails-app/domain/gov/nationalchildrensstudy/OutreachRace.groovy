...
class OutreachRace {
	...
	public static final String XSD_TABLE_NAME = "outreach_race"

	public OutreachRace(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'outreach_race_id':
									outreachRaceId = elementText
									break
