...
class SixMthSaqSupp2 {
	...
	public static final String XSD_TABLE_NAME = "six_mth_saq_supp_2"

	public SixMthSaqSupp2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'six_mth_saq_id':
									...
									break
								case 'six_month_supplement_id':
									sixMonthSupplementId = elementText
									break
								case 'supplement':
	...
	static constraints = {
		...
		supplement(nullable: false, inList:[1, 2, 3, -5, 5, -1, -2, -4])
