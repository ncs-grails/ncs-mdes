...
class TwelveMthSaqSupplement {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_saq_supplement"

	public TwelveMthSaqSupplement(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		supplement(nullable: false, inList:[1, 2, 3, 4, -1, -2, -4, -7])
