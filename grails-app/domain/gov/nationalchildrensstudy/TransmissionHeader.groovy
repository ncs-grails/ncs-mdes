...
class TransmissionHeader {
	...
	public static final String XSD_TABLE_NAME = "transmission_header"

	public TransmissionHeader(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'specification_version':
									specificationVersion = elementText
									break
								case 'is_snapshot':
									isSnapshot = elementText.toBoolean()
									break
								default:
									if (strict) {
