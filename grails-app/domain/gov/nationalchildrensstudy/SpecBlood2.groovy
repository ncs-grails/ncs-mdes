...
class SpecBlood2 {
	...
	public static final String XSD_TABLE_NAME = "spec_blood_2"

	public SpecBlood2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'collection_location':
									...
									break
								case 'ablood_coll_date':
									abloodCollDate = elementText
									break
	...
	static constraints = {
		...
		abloodCollDate(nullable: true, maxSize:10, matches:"([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?")
	...
	static mapping = {
		...
		abloodCollDate column:'ablood_coll_date'
