...
class EighteenMthMother2 {
	...
	public static final String XSD_TABLE_NAME = "eighteen_mth_mother_2"

	public EighteenMthMother2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		commContact(nullable: false, inList:[1, 2, 3, -1, -2, -4])
