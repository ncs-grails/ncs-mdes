...
class Person {
	...
	public static final String XSD_TABLE_NAME = "person"

	public Person(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'person_id':
									...
									break
								case 'prefix':
									prefix = elementText.toInteger()
									break
								case 'first_name':
									firstName = elementText
									break
								case 'last_name':
									lastName = elementText
									break
								case 'middle_name':
									middleName = elementText
									break
								case 'maiden_name':
									maidenName = elementText
									break
								case 'suffix':
									suffix = elementText.toInteger()
									break
								case 'title':
									title = elementText
									break
								case 'sex':
									sex = elementText.toInteger()
									break
								case 'age':
								...
								case 'person_dob':
									...
									break
								case 'deceased':
									deceased = elementText.toInteger()
									break
								case 'ethnic_group':
									ethnicGroup = elementText.toInteger()
									break
								case 'person_lang':
								...
								case 'maristat_oth':
									...
									break
								case 'pref_contact':
									prefContact = elementText.toInteger()
									break
								case 'pref_contact_oth':
									prefContactOth = elementText
									break
								case 'plan_move':
								...
								case 'date_move':
									...
									break
								case 'p_tracing':
									pTracing = elementText.toInteger()
									break
								case 'p_info_source':
									pInfoSource = elementText.toInteger()
									break
								case 'p_info_source_oth':
									pInfoSourceOth = elementText
									break
								case 'p_info_date':
									pInfoDate = elementText
									break
								case 'p_info_update':
									pInfoUpdate = elementText
									break
								case 'person_comment':
									personComment = elementText
									break
