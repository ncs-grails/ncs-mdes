...
class LinkPersonInstitute {
	...
	public static final String XSD_TABLE_NAME = "link_person_institute"

	public LinkPersonInstitute(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'person_institute_id':
									personInstituteId = elementText
									break
								case 'institute_id':
	...
	static constraints = {
		...
		instituteRelation(nullable: false, inList:[1, 2, 3, -5, -4])
