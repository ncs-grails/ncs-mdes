...
class TwelveMthSaqWater2 {
	...
	public static final String XSD_TABLE_NAME = "twelve_mth_saq_water_2"

	public TwelveMthSaqWater2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'twelve_mth_saq_id':
									...
									break
								case 'twelve_mth_saq_water_id':
									twelveMthSaqWaterId = elementText
									break
								case 'water_1':
									water1 = elementText.toInteger()
									break
								case 'water_1_oth':
									water1Oth = elementText
									break
	...
	static constraints = {
		...
		water1(nullable: false, inList:[1, 2, 3, -5, -1, -2, -3, -4])
