...
class TapWaterTwqSample {
	...
	public static final String XSD_TABLE_NAME = "tap_water_twq_sample"

	public TapWaterTwqSample(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tap_water_twq_id':
									...
									break
								case 'tap_water_twq_sample_id':
									tapWaterTwqSampleId = elementText
									break
								case 'sample_number':
