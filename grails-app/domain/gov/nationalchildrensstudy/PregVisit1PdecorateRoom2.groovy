...
class PregVisit1PdecorateRoom2 {
	...
	String pv1Id
	Integer pdecorateRoom
	String pdecorateRoomOth
	String transactionType
	public static final boolean DOMAIN_CLASS_FROM_XSD = true
	public static final String XSD_TABLE_NAME = "preg_visit_1_pdecorate_room_2"

	public PregVisit1PdecorateRoom2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv1_pdecorate_room_id':
									pv1PdecorateRoomId = elementText
									break
								case 'pv1_id':
									pv1Id = elementText
									break
								case 'pdecorate_room':
									pdecorateRoom = elementText.toInteger()
									break
	...
	static constraints = {
		...
		pdecorateRoom(nullable: false, inList:[1, 2, 3, 4, 5, 6, 7, -5, -1, -2, -3, -4])
