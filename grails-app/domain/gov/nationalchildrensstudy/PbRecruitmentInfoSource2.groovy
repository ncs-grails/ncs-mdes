...
class PbRecruitmentInfoSource2 {
	...
	public static final String XSD_TABLE_NAME = "pb_recruitment_info_source_2"

	public PbRecruitmentInfoSource2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		pbInstiInfoSource(nullable: false, inList:[1, 2, 3, 4, -1, -2, -4])
