...
class SpecCordBlood3 {
	...
	public static final String XSD_TABLE_NAME = "spec_cord_blood_3"

	public SpecCordBlood3(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'cord_delivery':
									...
									break
								case 'cord_method':
									cordMethod = elementText.toInteger()
									break
								case 'cord_method_oth':
									cordMethodOth = elementText
									break
								case 'cord_container':
	...
	static constraints = {
		...
		cordMethod(nullable: false, inList:[1, -5, -1, -2, -3, -4])
		cordMethodOth(nullable: true, maxSize:255)
		cordContainer(nullable: false, inList:[1, 2, 3, -1, -2, -3, -4])
		overallComments(nullable: false, inList:[1, 2, -3, -4])
	...
	static mapping = {
		...
		cordMethod column:'cord_method'
		cordMethodOth column:'cord_method_oth'
