...
class PregVisit1RoomMold2 {
	...
	public static final String XSD_TABLE_NAME = "preg_visit_1_room_mold_2"

	public PregVisit1RoomMold2(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'psu_id':
									...
									break
								case 'pv1_room_mold_id':
									pv1RoomMoldId = elementText
									break
								case 'pv1_id':
									pv1Id = elementText
									break
	...
	static constraints = {
		...
		roomMold(nullable: false, inList:[1, 2, 3, 4, 5, 6, 7, -5, -1, -2, -3, -4])
