...
class HouseholdInventoryAgeElig {
	...
	public static final String XSD_TABLE_NAME = "household_inventory_age_elig"

	public HouseholdInventoryAgeElig(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'p_id':
									pId = elementText
									break
								case 'household_inventory_age_elig_id':
									householdInventoryAgeEligId = elementText
									break
								case 'age_elig_fname':
