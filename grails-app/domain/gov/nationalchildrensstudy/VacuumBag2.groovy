...
class VacuumBag2 {
	...
	public static final String XSD_TABLE_NAME = "vacuum_bag_2"

	public VacuumBag2(XMLStreamReader reader, boolean strict) {
	...
	static constraints = {
		...
		vbCollDate(nullable: true, maxSize:10, matches:"([0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9])?")
		...
		vacuumBagChangedFreq(nullable: false, inList:[1, 2, 3, 4, -3, -4])
		...
		equipId(nullable: true, maxSize:32)
		vacuumTemp(nullable: true, matches:"([-+]?[\\d]{1,9})?")
		vacuumRh(nullable: true, matches:"([-+]?[\\d]{1,9})?")
		vacuumBag(nullable: false, inList:[1, 2, 3, -5, -1, -2, -3, -4, -7])
	...
	static mapping = {
		...
		vbCollDate column:'vb_coll_date'
