...
class ListingUnit {
	...
	public static final String XSD_TABLE_NAME = "listing_unit"

	public ListingUnit(XMLStreamReader reader, boolean strict) {
						...
						if ( elementText ) {
							switch ( elementName ) {
								...
								case 'tsu_id':
									...
									break
								case 'list_line':
									listLine = elementText.toInteger()
									break
								case 'list_source':
									listSource = elementText.toInteger()
									break
								case 'list_comment':
									listComment = elementText
									break
	...
	static constraints = {
		...
		listSource(nullable: false, inList:[1, 2, 3, -4])
